...
export default function JobDetail() {
  ...
  const totalReleased = job.milestones?.filter((m: Milestone) => m.status === 'released').reduce((sum: number, m: Milestone) => sum + Number(m.amount), 0) || 0;
      ...
      <div className="max-w-4xl mx-auto space-y-10 animate-fade-in pb-20">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            {job.milestones?.sort((a: any, b: any) => (a as any).order_index - (b as any).order_index).map((milestone: Milestone, idx: number) => (
